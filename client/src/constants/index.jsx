export const features = [
    {
      ...
      caption: "Easy screenshot & QR",
      title: "Capture and Convert",
      text: "This web app captures website screenshots from a given URL and transforms the input data into a PDF. It includes an embedded QR code, providing users with quick and efficient tools for presenting data in an organized and accessible format.",
      button: {
    ...
    },
    {
      ...
      title: "Generate what you want",
      text: " A simple web app that creates random user data, including names, email addresses, and other basic details. The generated data can be easily exported and saved as a CSV file, making it useful for testing and development purposes.",
      button: {
        icon: "/images/docs.svg",
        title: "Watch the demo",
        link:"/home/random-data-generator"
      },
    },
  ...
  export const details = [
    {
      ...
      title: "AI automated random data ",
    },
    {
      id: "1",
      icon: "/images/detail-2.png",
      title: "Creating URl to screenshot",
    },
    {
      id: "2",
    ...
    },
    {
      ...
      title: "Input to QR code generate",
    },
  ];
  ...
  export const socials = [
    {
      ...
      url: "https://github.com/sidhyaashu",
    },
    {
      id: "1",
      title: "Threads",
